...
#Modified to treat the inviter username and invitee username to be treated as email addresses 
...
def play():
    ...
    if form:
        ...
        SENDER = "Sender Name <cantrek2csci497u@gmail.com"
        RECIPIENT = invitee
        CONFIGURATION_SET = "ConfigSet"
        AWS_REGION = "us-west-2"
        SUBJECT = "Game invite"
        BODY_TEXT = ("You have a new game inivte"
            )
        CHARSET = "UTF-8"
        try:
